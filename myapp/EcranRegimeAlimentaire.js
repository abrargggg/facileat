...
function EcranRegimeAlimentaire() {
  ...
  const diets = [{ name: 'Végétarien', icon: require('./assets/1.png') },
  { name: 'Flexitarien', icon: require('./assets/2.png') },
  { name: 'Pescétarien', icon: require('./assets/3.png') },
  { name: 'Régime cétogène', icon: require('./assets/4.png') },
  { name: 'Végan', icon: require('./assets/5.png') },
  { name: 'Végétalien', icon: require('./assets/6.png') },
  { name: 'Régime sans porc', icon: require('./assets/7.png') },
  { name: 'Régime sans sel', icon: require('./assets/8.png') },
  { name: 'Régime DASH', icon: require('./assets/9.png') },
  { name: 'Régime sans résidus', icon: require('./assets/10.png') },
  { name: 'Autre', icon: require('./assets/11.png') },
  { name: 'Aucun', icon: require('./assets/12.png') },
  ...
  // ...
  return (
    <ImageBackground source={require('./assets/laa.jpg')} style={styles.background}>
