...
function EcranPropose() {
  ...
  return (
    ...
    <ImageBackground source={require('../../../assets/images/laa.jpg')} style={styles.backgroundImage}>
      ...
      <View style={styles.container}>
          ...
          {/* <TouchableOpacity onPress={() => navigation.goBack()}>
            <View style={styles.bandeauRetour}>
              <Ionicons name="arrow-back-sharp" size={20} color={Colors.blanc} style={styles.iconColor} />
            </View>
          </TouchableOpacity> */}
          <TouchableOpacity onPress={()=>navigation.goBack()} style={styles.bandeauRetour}>
            <AntDesign name="arrowleft" size={30} color={Colors.dark} />
          </TouchableOpacity>
        ...
        <Image
    source={require('../../../assets/images/ligne.png')}
     style={styles.centeredImage}
   />
     <View style={{marginBottom: 10}}/>
        <TouchableOpacity
      style={styles.generateButton}
       onPress={() => navigation.navigate('attente')}
       >
